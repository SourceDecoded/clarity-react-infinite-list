(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["clarity-react-infinite-list"] = factory();
	else
		root["clarity-react-infinite-list"] = factory();
})(this, function() {
...
exports.ListViewDataSource = exports.ListView = undefined;

var _ListView = __webpack_require__(19);

var _ListView2 = _interopRequireDefault(_ListView);

var _ListViewDataSource = __webpack_require__(20);
...
exports.ListViewDataSource = _ListViewDataSource2.default;
...
var ListView = function (_Component) {
    ...
    _createClass(ListView, [{
        key: "_setRenderableBatches",
        value: function _setRenderableBatches() {
            var _this2 = this;
        ...
        key: "_getRenderableBatches",
        value: function _getRenderableBatches() {
            var _this3 = this;

            var _state = this.state,
                firstBatchIndex = _state.firstBatchIndex,
                lastBatchIndex = _state.lastBatchIndex;
            var _props = this.props,
                dataSource = _props.dataSource,
                renderRow = _props.renderRow;

            var numberOfBatches = dataSource.getBatchCount();
            var batches = [];
            ...
            var _loop = function _loop(i) {
                if (i >= firstBatchIndex && i <= lastBatchIndex) {
                    (function () {
                        var batchIndex = i;
                        var batch = dataSource.getBatchData(batchIndex);
                        var batchContainerElement = _react2.default.createElement(
                            "div",
                            { ref: function ref(div) {
                                    return _this3["batchContainer" + batchIndex] = div;
                                }, key: batchIndex },
                            batch.map(function (item, itemIndex) {
                    ...
                    var emptyBatchContainer = _this3["batchContainer" + i] || null;

                    if (emptyBatchContainer) {
                        var emptyContainerHeight = _this3["batchContainer" + i].style.height;
                        var emptyBatchContainerElement = _react2.default.createElement("div", { style: { height: emptyContainerHeight }, ref: function ref(div) {
                                return _this3["batchContainer" + i] = div;
                            }, key: i });
...
var ListViewDataSource = function () {
    ...
    _createClass(ListViewDataSource, [{
        ...
        value: function appendRows(dataBlob) {
            return this.cloneWithRows(dataBlob);
        }
    }, {
        key: "prependRows",
        ...
        key: "getBatchData",
        value: function getBatchData(batchIndex) {
